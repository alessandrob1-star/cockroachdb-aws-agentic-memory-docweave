...
| MVP-003 | Identity-safe move and copy | AC-005, AC-006 | Filesystem execution and persistence integrity tests | In progress; local operation planning, approval binding, restore contracts, mass rename/move previews, lineage-row projections, and CockroachDB file-lineage persistence contracts are tested without mutating files; live persistence and UI execution controls remain pending |
