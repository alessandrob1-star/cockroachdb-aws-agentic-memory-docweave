...
| PROD-008 | Complete desktop and cloud product parity | `product-requirements.md` FR-047–FR-050 | Cross-surface contract and end-to-end tests | In progress; local desktop discovery, cancellation, session state, multi-selection, and guarded read-only PDF preview exist, while complete review, desktop workflow, and cloud parity remain pending |
