...
| SEC-015 | Immutable originals and audit | Content hashes, versioned objects, append-only events | Integrity tests and demo | In progress; local events, restore audit events, atomic hash-chained adapter, fail-closed execution ordering, parameterized CockroachDB-ready audit appends, and restart-state validation implemented; live durable audit pending |
