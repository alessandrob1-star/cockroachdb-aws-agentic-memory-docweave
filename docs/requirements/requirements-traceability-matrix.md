...
| QUAL-004 | Integration and contract tests | Real CockroachDB and mocked or sandboxed AWS boundaries as appropriate | Integration report | In progress; offline migrations and local operation, classification, review-decision, and file-lineage transaction contracts are complete; revision `0001` has isolated live schema evidence, while revisions `0002`, `0003`, and `0004` and online application integration remain pending live validation |
