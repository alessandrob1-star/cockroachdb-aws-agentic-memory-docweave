...
| PROD-003 | Explainable analysis, classification, naming, and relationships | `product-requirements.md` FR-011–FR-017, `domain-data-requirements.md` taxonomy baseline, and `classification-and-confidence-specification.md` | Curated-corpus evaluation and trace evidence | In progress; real page-level extraction is isolated and verified on the initial 30-PDF corpus, while Bedrock analysis, evidence validation, naming, relationships, and evaluation remain pending |
