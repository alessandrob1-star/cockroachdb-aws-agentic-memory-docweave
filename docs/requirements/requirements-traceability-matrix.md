...
| PROD-005 | Safe copy, move, resume, and restore | `product-requirements.md` FR-025–FR-034 | Planning, execution, failure-injection, and end-to-end tests | In progress; durable intent/result orchestration, restart-state handling, classification-derived non-mutating copy planning, review-decision binding to the exact operation-plan preview, and cockpit confirmation that review decisions do not execute copy or move operations are locally tested; live persistence, cockpit execution, and restore remain pending |
