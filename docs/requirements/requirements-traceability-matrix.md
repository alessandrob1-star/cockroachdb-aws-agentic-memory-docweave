...
| ENV-007 | Amazon Bedrock primary profile | Temporary European Amazon Nova 2 Lite profile active in `eu-central-1` | One bounded synthetic classification validated, side-effect-free Bedrock client composition implemented, and a controlled single-PDF runtime command added; desktop-triggered runtime invocation and corpus-quality evaluation pending |
