...
| PROD-005 | Safe copy, move, resume, and restore | `product-requirements.md` FR-025–FR-034 | Planning, execution, failure-injection, and end-to-end tests | In progress; durable intent/result orchestration, restart-state handling, and classification-derived non-mutating copy planning are locally tested; live persistence, human approval wiring, execution from the cockpit, and restore remain pending |
