...
The local core also has a restore contract for prior successful copy and move
results. Restore planning blocks changed generated copies, changed moved files,
